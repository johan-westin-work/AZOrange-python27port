...
# self.badVarCountData
    ...
    def testMetaDataHandleForSavingModel(self):
        ...
        expected_AccNoMetaAfter = [0.545454545455, 0.533333333333, 0.442424242424, 0.551515151515, 0.454545454545] #Ver 0.3 - Artifact: The extra values can be expected on other Systems: [AZInHouse, Ubuntu10.04, Ubuntu10.10, Ubuntu10.10] 
